...
module StringCalculator
  class Calculator
    include StringCalculator::Constants::Delimiters
    ...
    def check_negatives!
      ...
      raise StringCalculator::Errors::NegativeNumberError,
            "Negative numbers are not allowed: #{negative_digits.join(', ')}"
    end
    ...
    def find_digits!
      ...
      raise StringCalculator::Errors::InvalidInputError, 'Invalid input error' if @digits.include?('')
